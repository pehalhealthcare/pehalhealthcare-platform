# PehalHealthcare Platform

PehalHealthcare is a secure, scalable digital healthcare ecosystem connecting patients, doctors, clinics, businesses, and administrators through integrated healthcare, EMR, telemedicine, payments, analytics, and AI-powered services.
...
│   │   │       ├── Header.tsx
│   │   │       ├── Main.tsx
│   │   │       ├── HealthcareEcosystem.tsx
│   │   │       ├── Features.tsx
│   │   │       ├── EMRVault.tsx
│   │   │       ├── PatientPlatform.tsx
│   │   │       ├── DoctorPlatform.tsx
│   │   │       ├── BusinessPlatform.tsx
│   │   │       ├── TrustSecurity.tsx
│   │   │       └── Footer.tsx
│   │   │
│   │   ├── auth/
...
| Directory | Purpose |
|---|---|
| `pages/public/` | Public Landing Page: Header, Hero, Healthcare Ecosystem, Features, EMR Vault, Patient Platform, Doctor Platform, Business Platform, Trust & Security, Footer |
...
| File | Purpose |
|---|---|
| `AppRoutes.tsx` | Central route configuration — defines the full route tree for public, auth, and portal paths |
